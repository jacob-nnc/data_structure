...
namespace json
{
    ...
    struct obj : public value
    {
        ...
        obj& operator=(const obj& item)
        {
            for (auto i : val)delete i.second;
            this->val = item.val;
            this->_insert = item.keys();
            return *this;
        }

        json::value* operator[](const std::string& index)
        {
            return val[index];
        }

        void insert(const std::string& index, json::value* _val)
        {
            _insert.push_back(index);
            val[index] = _val;
        }
    ...
    struct arr : public value
    {
        ...
        arr& operator=(const arr& item)
        {
            for (auto i : val)delete i;
            this->val = item.val;
            return *this;
        }
    ...
    struct j_bool : public value
    {
        ...
        j_bool& operator=(const j_bool& item)
        {
            this->val = item.val;
            return *this;
        }
